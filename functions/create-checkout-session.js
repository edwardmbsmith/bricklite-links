export async function onRequest({ request, env }) {
  ...
  form.append('line_items[0][price_data][product_data][name]', 'BrickLite NFC token');
  form.append('line_items[0][price_data][product_data][description]', 'One NFC token to access BrickLite. UK shipping only.');

  form.append('shipping_options[0][shipping_rate_data][display_name]', 'Royal Mail 2nd Class');
  form.append('shipping_options[0][shipping_rate_data][type]', 'fixed_amount');
  form.append('shipping_options[0][shipping_rate_data][fixed_amount][amount]', '150');
